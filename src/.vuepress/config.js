...
module.exports = {
    ...
    head: [
        ...
        ['meta', { name: 'title', content: "Entahlah blog" }],
        ['meta', { 'http-equiv': 'Content-Type', content: "text/html" }],
        ['link', { rel: 'icon', href: "https://blog.eenthlh.xyz/img/Icon-512×512.png" }],
        ['link', { rel: 'alternate', hreflang: "id", href: "https://blog.eenthlh.xyz/" }],
        ['meta', { property: 'og:locale', content: "en_id" }],
        ['meta', { property: 'og:type', content: "website" }],
        ['meta', { property: 'og:title', content: "Entahlah blog" }],
        ...
        ['meta', { name: 'twitter:title', content: "Entahlah blog" }],
